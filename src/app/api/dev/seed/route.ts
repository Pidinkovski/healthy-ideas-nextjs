...
// Usage: POST /api/dev/seed (or GET for convenience)
...
export async function POST(_request: NextRequest) {
  try {
    ...
    // NOTE: conciseContent must be <= 30 chars (Idea schema)
    const seedIdeas = [
      // WORKOUT
      {
        ...
        conciseContent: 'Beginner home workout plan',
        category: 'workout',
      },
      {
        ...
        conciseContent: '30-min HIIT for busy days',
        category: 'workout',
      },
      ...
      // LIFESTYLE
      {
        ...
        conciseContent: 'Sleep routine that works',
        category: 'lifestyle',
      },
      {
        ...
        conciseContent: 'Build a better daily plan',
        category: 'lifestyle',
      },
      ...
      // FOOD
      {
        ...
        conciseContent: '5-min high-protein bowl',
        category: 'food',
      },
      {
        ...
        conciseContent: '3-day meal prep basics',
        category: 'food',
      },
      ...
      // MINDFUL
      {
        ...
        conciseContent: '5-min mindfulness check-in',
        category: 'mindful',
      },
      {
        ...
        conciseContent: 'Box breathing for stress',
        category: 'mindful',
      },
    ].map((idea) => ({
      ...idea,
