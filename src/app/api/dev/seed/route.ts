...
// IMPORTANT: call once, then optionally delete or protect this route.
  ...
  try {
    ...
    const seedIdeas = [
      // WORKOUT
      {
        ...
        conciseContent: 'Simple 3x/week home routine for beginners, no equipment needed.',
        category: 'workout',
      },
      {
        title: '30-Minute HIIT Routine for Busy Days',
        imageUrl: 'https://images.pexels.com/photos/6453397/pexels-photo-6453397.jpeg',
        description:
      ...
      // LIFESTYLE
      {
        ...
        conciseContent: 'Simple evening habits that help you fall asleep faster and wake up rested.',
        category: 'lifestyle',
      },
      {
        ...
        conciseContent: 'Use simple focus, movement, admin, and recovery blocks to structure your day.',
        category: 'lifestyle',
      },
      ...
      // FOOD
      {
        ...
        conciseContent: 'Fast breakfast with protein, fiber and healthy fats to reduce cravings.',
        category: 'food',
      },
      {
        ...
        conciseContent: 'Cook once and mix protein, carbs, and veggies into 3 days of easy meals.',
        category: 'food',
      },
      ...
      // MINDFUL
      {
        ...
        conciseContent: 'Short sensory and breathing practice to start the day more grounded.',
        category: 'mindful',
      },
      {
        title: 'Box Breathing Technique for Stressful Moments',
        imageUrl: 'https://images.pexels.com/photos/3822620/pexels-photo-3822620.jpeg',
        description:
        ...
        conciseContent: 'Use 4–4–4–4 breathing to quickly reduce stress and regain control.',
        category: 'mindful',
      },
    ].map((idea) => ({
      ...idea,
      _createdOn: now,
      // _ownerId will be left empty for seed; frontend will still display ideas
    }));

    // For seeding we create ideas without a specific owner.
    // The Idea model requires _ownerId; in a real app you might attach these to a demo/admin user.
    // Here we insert directly and rely on MongoDB to accept the documents as-is.

    await Idea.insertMany(seedIdeas as any);
